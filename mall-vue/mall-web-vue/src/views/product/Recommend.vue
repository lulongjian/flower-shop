    ...
    <div id="AllProduct" v-if="flag == true">
      <div id="Goods">
        ...
        <div class="search" style="margin-top: 20px; text-align: center;">
          <span>推荐日期:</span>
          <el-date-picker v-model="reTime" type="date" placeholder="选择推荐日期" value-format="yyyy-MM-dd"
...
import { getRecommendListRequest, getMessageListRequest, addMessageRequest, addCarRequest, getProductTypeAllListRequest } from "@/api/index"
