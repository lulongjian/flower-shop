...
public class SysController {
	...
	public JsonModel getCode(String email){
		...
		//邮件主题
		String emailTitle = "【时茪集花店】";

		//邮件内容
		String emailContent = "亲爱的用户，您好! 非常感谢您注册时茪集花店，您的验证码为 ["+verifyCode+"]，请勿泄露，谨防被骗，" +
...
//			redisUtils.setEmailCode(email,verifyCode);
	...
	public JsonModel getCodeUpdatePassword(String email){
		...
		//邮件内容
		String emailContent = "亲爱的用户，您好! 时茪集花店提醒您正在修改密码，您的验证码为 ["+verifyCode+"]，请勿泄露，谨防被骗，" +
				"验证码有效时间为5分钟，如已过期请重新获取";
